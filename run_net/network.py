...
def run_gcdn(input_path_name):

    ################################################################################################
    input_path_name = input_path_name +"_joint_position_gcdn_list.xlsx"
    output_path_name = input_path_name + "gcdn_predicted.npy"
    ...
    input_features = dragonV.get_sliding_window(selected_norm_frame_data_list, 9)
    ...
    model_weights = torch.load('gcdn_n/models/100_epochs.pth', map_location=torch.device('cpu'))
